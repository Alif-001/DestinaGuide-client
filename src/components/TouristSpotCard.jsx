...
const TouristSpotCard = ({
  ...
  return (
    <div
      className="flex flex-col shadow-xl rounded-xl overflow-hidden transform transition-all duration-300 ease-in-out mb-8 border"
      style={{
    ...
    >
      ...
      <div className="p-6 space-y-4 flex-grow">
        <h2 className="text-2xl font-extrabold truncate">{spotName}</h2>
        <p className="text-sm truncate">
          📍 {location}, {country}
        </p>
        <p className="text-base overflow-clip text-ellipsis line-clamp-3 truncate">
